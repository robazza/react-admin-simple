...
import { Edit, Show, SimpleForm, TextInput, DateInput, ReferenceManyField, Datagrid, TextField, DateField, EditButton, required, useRecordContext } from 'react-admin';
...
const ProcessosEdit = () => (
    <Edit component="div" title={<>eeee</>}  className="XXXE" sx={{backgroundColor: 'inherit', height: '100%', width: '100%', 
    '& .RaEdit-main': {
        height: '100%',
        marginTop: '0'
    },
...
const Visao3 = () => {
    ...
    return (
        <Box style={{display:"flex", flexDirection: 'row', width: '100%', height: '100%', justifyContent:'flex-start', padding: '1em 0em 1em 0em', gap: '1em'}} className="XXBOX"> 
            ...
            <Box  style={{ flex:'flex: 1 1 auto;', alignItems: 'stretch', height: '100%',  width: '300px', borderRadius: '0.5em'  }}>
                        ...
                        {tramites.map((event,i) => (
                            ...
                            >
                                ...
                                {event.conteudo.map(arquivo => (
                                    ...
                                    {false && `<RecordContextProvider value={event.data}>
                                        {event.type === 'order' ? (
                                            <Order />
                                        ) : (
                                            <Review />
